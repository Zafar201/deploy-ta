      ...
      <Row className="superadmin-top">
        ...
        <Col>
          <Row className="sup-sg">
            {adminInfo && <Button onClick={signoutHandler}>Signout</Button>}
          </Row>
        </Col>
      </Row>
              ...
              <>
                <Row key={user._id} className="updatebooking-body-card">
                  ...
                  <Col
                    ...
                    className="signup-body-button"
                  >
                    <button
                      type="submit"
                      onClick={() => rejectHandler(user._id)}
                    >
                      decline
                    </button>
                  </Col>
