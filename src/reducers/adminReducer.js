...
export const countListReducer = (state = { loading:true,count:[] }, action) => {
  ...
  export const getAgentSignupRequestReducer=(state={loading:true,users:[]},action)=>{
    switch(action.type){
      case AGENT_GET_SIGNUP_REQUEST:
        return {loading:true};
      case AGENT_GET_SIGNUP_SUCCESS:
        return {loading:false,users:action.payload.users};
      case AGENT_GET_SIGNUP_FAIL:
        return {loading:false,error:action.payload}
  ...
  export const agentApproveReducer= (state= {}, action)=>{
    switch(action.type){
      case APPROVE_AGENT_REQUEST:
        return {loading:true};
      case APPROVE_AGENT_SUCCESS:
        return {loading:false,success:true};
      case APPROVE_AGENT_FAIL:
        return {loading:false,error:action.payload}
      case APPROVE_AGENT_RESET:
        return {};
      default:
        return state;        
    }
  ...
  export const agentRejectReducer= (state= {}, action)=>{
    switch(action.type){
      case REJECT_AGENT_REQUEST:
        return {loading:true};
      case REJECT_AGENT_SUCCESS:
        return {loading:false,done:true};
      case REJECT_AGENT_FAIL:
        return {loading:false,error:action.payload}
      case REJECT_AGENT_RESET:
        return {};
      default:
        return state;        
    }
  ...
  export const agentBookingListReducer = (state = { loading:true }, action) => {
    switch (action.type) {
      case AGENT_BOOKING_DETAILS_REQUEST:
        return { loading: true };
      case AGENT_BOOKING_DETAILS_SUCCESS:
        return { loading: false, property: action.payload }; 
      case AGENT_BOOKING_DETAILS_FAIL:
        return { loading: false, error: action.payload };
      default:
        return state;
    }
  ...
  export const agentApproveBookingReducer= (state= {}, action)=>{
    switch(action.type){
      case APPROVE_AGENT_BOOKING_REQUEST:
        return {loading:true};
      case APPROVE_AGENT_BOOKING_SUCCESS:
        return {loading:false,success:true};
      case APPROVE_AGENT_BOOKING_FAIL:
        return {loading:false,error:action.payload}
      case APPROVE_AGENT_BOOKING_RESET:
        return {};
      default:
        return state;        
    }
  ...
  export const agentRejectBookingReducer= (state= {}, action)=>{
    switch(action.type){
      case REJECT_AGENT_BOOKING_REQUEST:
        return {loading:true};
      case REJECT_AGENT_BOOKING_SUCCESS:
        return {loading:false,success:true};
      case REJECT_AGENT_BOOKING_FAIL:
        return {loading:false,error:action.payload}
      case REJECT_AGENT_BOOKING_RESET:
        return {};
      default:
        return state;        
    }
