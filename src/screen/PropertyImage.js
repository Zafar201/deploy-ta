...
import { DELETE_PROPIMG_RESET, URL } from '../constants/generalConstants';
...
function PropertyImage() {
    ...
    const uploadimages = () =>
    {
          for(var a = 0; a<images.length; a++)
          {
            ...
            axios.post(`${URL}/api/users/property-upload/${propertyId}`, fd,{
                headers: {
    ...
    const deleteHandler=(imageId)=>{
      axios.post(`${URL}/api/users/property-delete`,{
       propId:propertyId,
       imageId
      })
