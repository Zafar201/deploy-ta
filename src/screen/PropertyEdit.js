...
function PropertyEdit() {
  ...
  const [defultTr, setDefaultTr] = useState(true);
  ...
  useEffect(() => {
    ...
    if (!property || property._id !== propertyId || successUpdate) {
      ...
      setHolidaytype(property.holiday_type);
      setAddress(property.address);
      setLocation(property.location);
      setMap(property.map);
      setRating(property.starring);
      setRestaurent(property.restaurants);
      setBars(property.bars);
      setCheckin(property.checkin);
      setCheckout(property.checkout);
      setTax(property.tax);
      setDiscount(property.discount);
      setMultiInput(property.extra_charges);
      setMeals(property.meals);
      setTransfer(property.transfer);
  ...
  const handleRemoveClick = (e, index) => {
    ...
    setMultiInput(inputList);
    // console.log(multiInput,'multiInput')
  };
          ...
          <Container>
            <Row>
              ...
              <Col className="add-img">
                <button onClick={() => navigate(`/addimage/${propertyId}`)}>
                  Add images
                </button>
              </Col>
            </Row>
            ...
            <form onSubmit={submitHandler}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                >
                  ...
                  {property.transfer.map((tr) => (
                    <>
                      <Col
                        style={{ display: "flex" }}
                        className="addprop-checkbox"
                      >
                        <h2> {tr.type}</h2>
                        <input
                          type="checkbox"
                  ...
                  {!showTransfer && (
                    <h3 className="showtr" onClick={showtr}>
                      Edit Transfer
                    </h3>
                  )}
                  {showTransfer && (
                  ...
                  {showTransfer && (
                    <Col
                      ...
                      className="addprop-checkbox"
                    >
                      <h2> Private chartered Manta Seaplane</h2>
                      <input
                        type="checkbox"
                        checked={isClicked3}
                ...
                >
                  ...
                  {property.meals.map((itm) => (
                    ...
                    {!showMeals && (
                    <h3 className="showtr" onClick={showml}>
                      Edit Meals
                    </h3>
                  )}
