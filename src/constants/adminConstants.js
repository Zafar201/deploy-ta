...
export const AGENT_GET_SIGNUP_REQUEST ='AGENT_GET_SIGNUP_REQUEST'
export const AGENT_GET_SIGNUP_SUCCESS ='AGENT_GET_SIGNUP_SUCCESS'
export const AGENT_GET_SIGNUP_FAIL ='AGENT_GET_SIGNUP_FAIL'

export const APPROVE_AGENT_REQUEST ='APPROVE_AGENT_REQUEST'
export const APPROVE_AGENT_SUCCESS ='APPROVE_AGENT_SUCCESS'
export const APPROVE_AGENT_FAIL ='APPROVE_AGENT_FAIL'
export const APPROVE_AGENT_RESET ='APPROVE_AGENT_RESET'
...
export const REJECT_AGENT_RESET ='REJECT_AGENT_RESET'